...
! **********************************************************************
      ...
      if (.not.associated(d_matrix_start )) then
         ...
         d_matrix_start %number= DSP_MATRIX   !2  
         write(*,*) 'd_matrix_start.number', d_matrix_start %number
         d_matrix_start %number=- d_matrix_start %number    
         write(*,*) 'after subtrice d_matrix_start.number', d_matrix_start %number
         nullify(d_matrix_start %pntr)      
      else
         allocate(matrix_insert,STAT=ierr)
         matrix_insert%number= d_matrix_start %number-no_of_types
         write(*,*) 'matrix_insert.number', matrix_insert %number
